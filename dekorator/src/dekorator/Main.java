...
public class Main {
	public static void main(String[] args) {
		...
		System.out.printf("1. %s.%n Cena: %.2f PLN%n",
				lakierowanie.getOpis(), lakierowanie.getCena());
		lakierowanie = new OpcjaMetaliczne(lakierowanie);
		System.out.printf("2. %s.%n Cena: %.2f PLN%n",
				lakierowanie.getOpis(), lakierowanie.getCena());
		lakierowanie = new OpcjaZPlomieniami(lakierowanie);
		System.out.printf("3. %s.%n Cena: %.2f PLN%n",
				lakierowanie.getOpis(), lakierowanie.getCena());
		lakierowanie = new OpcjaZChromowaniem(lakierowanie);
		System.out.printf("4. %s.%n Cena: %.2f PLN%n",
				lakierowanie.getOpis(), lakierowanie.getCena());
	}
